        ...
        columnDefs = [
            ...
            },
            {
                ...
                render: function (data, type, full, meta) {
                    ...
                    return '<div class="d-flex gap-3 justify-content">' +
                        '<button class="text-white bg-success border-0 p-1 rounded-4" onclick="openManageSourceModal(' + id + ')" title="Edit"> <i class="fa-solid fa-pen-to-square"></i> Edit</button>' +
                        '                                <button class="text-white bg-danger border-0 p-1 rounded-4" onclick="removeSource(' + full.id + ')" title="Delete"> <i class="fa-solid fa-trash"></i> Delete</button>' +
                        '                              </div>';
                }
            }
        ],
