...
use App\Exports\AdminBranchExport;
class BranchController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $request->validate([
            'first_name' => 'required',
            'last_name' => 'required',
            'branch_name' => 'required|unique:agent_users',
    ...
    public function edit($id)
    {
        ...
        $data['data'] = $result;
        return view('branch::modal.edit')->with($data);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $request->validate([
            'first_name' => 'required',
            'last_name' => 'required',
            'branch_name' => 'required|unique:agent_users,branch_name,'.$id. ',id',
    ...
    {
        return Excel::download(new AdminBranchExport, 'branch.xlsx');
    }

    public function print()
    {
        $users = AgentUsers::get();
        return view('branch::print',compact('users'));
