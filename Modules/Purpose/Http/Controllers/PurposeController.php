...
namespace Modules\Purpose\Http\Controllers;
...
class PurposeController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('purpose::model.add')->with($data);
    }
    ...
    public function show($id)
    {
        ...
        $data['data'] = $result;
        $data['dataDocuments'] = RequiredDocuments::get()->toArray();
        return view('purpose::model.view')->with($data);
    }
    ...
    public function edit($id)
    {
        ...
        $data['data'] = $result;
        $data['dataDocuments'] = RequiredDocuments::get()->toArray();
        return view('purpose::model.edit')->with($data);
    }
