    ...
    <div class="modal-dialog  modal-lg modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title fw-bold" id="exampleModalLabel" style="color: #2565ab;">Edit Currency</h5>
                <div type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></div>
            </div>
            <div class="modal-body">
                <form action="{{url('admin-login/currencyrate/update')}}/{{$data['cur_id']}}" method="post" class="form form-vertical save-form" id="save-currencyrate-form" enctype="multipart/form-data" files="true">
                    <div class="row">
