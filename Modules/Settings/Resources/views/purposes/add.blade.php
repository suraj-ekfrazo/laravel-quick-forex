    ...
    <div class="modal-dialog  modal-lg modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{route('managePurposes.save')}}" method="post" class="form form-vertical save-form" id="save-agent-form" enctype="multipart/form-data" files="true">
                <div class="row mt-3">
                    ...
                    <div class="col-md-6 col-lg-6 mt-3">
                        ...
                        <div class="input-group mb-3">
                            <input class="form-control p-2" name="tcs" type="number" step="0.01" min="0" placeholder="Enter TCS">
