    ...
    <div class="modal-dialog  modal-lg modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title fw-bold" id="exampleModalLabel" style="color: #2565ab;">Create Admin User</h5>
                <div type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></div>
            </div>
            <div class="modal-body">
                <form action="{{route('admin-user.save')}}" method="post" class="form form-vertical save-form" id="save-customer-form">
                    <div class="row">

                        <div class="col-md-6 col-lg-6  mt-3">
                            <label class="d-none">Name*</label>
                            <div class="input-group mb-3">
                                <input class="form-control  qf-shadow-input" type="text" name="name" placeholder="Enter Name">
                        ...
                        <div class="col-md-6 col-lg-6  mt-3">
                            ...
                            <div class="input-group mb-3">
                                <input class="form-control qf-shadow-input" type="text" oninput="this.value=this.value.replace(/[^0-9]/g,'');" maxlength="16" name="mobile_no" placeholder="Enter Mobile Number">
                        ...
                        <div class="col-md-6 col-lg-6  mt-3">
                            ...
                            <div class="input-group mb-3">
                                <input class="form-control qf-shadow-input" type="text" name="email" placeholder="Enter Email Id">
                        ...
                        <div class="col-md-6 col-lg-6  mt-3">
                            ...
                            <div class="input-group mb-3">
                                <input class="form-control qf-shadow-input" type="text" name="user_name" placeholder="Enter User Name">
