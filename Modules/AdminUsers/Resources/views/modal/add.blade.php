                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-lg-6  mt-3">
                            ...
                            <div class="input-group mb-3">
                                <input class="form-control  p-2" type="text" name="name" placeholder="Enter Name">
                        ...
                        <div class="col-md-6 col-lg-6  mt-3">
                            ...
                            <div class="input-group mb-3">
                                <input class="form-control p-2" type="text" oninput="this.value=this.value.replace(/[^0-9]/g,'');" maxlength="16" name="mobile_no" placeholder="Enter Mobile Number">
                        ...
                        <div class="col-md-6 col-lg-6  mt-3">
                            ...
                            <div class="input-group mb-3">
                                <input class="form-control p-2" type="text" name="email" placeholder="Enter Email Id">
                        ...
                        <div class="col-md-6 col-lg-6  mt-3">
                            ...
                            <div class="input-group mb-3">
                                <input class="form-control p-2" type="text" name="user_name" placeholder="Enter User Name">
