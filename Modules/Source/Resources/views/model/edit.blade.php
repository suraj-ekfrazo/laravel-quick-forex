    ...
    <div class="modal-dialog  modal-lg modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{url('admin-login/source/update')}}/{{$data['id']}}" method="post" class="form form-vertical save-form" id="save-sources-form" enctype="multipart/form-data" files="true">
                    <div class="row">
                        <div class="col-md-6 col-lg-6 mt-3">
                            <label class="d-none">Source Name*</label>
                            <div class="input-group mb-3">
                                <input class="form-control qf-shadow-input" name="source_name" type="text" placeholder="Enter Purpose Name" value="{{$data['source_name']}}">
                        ...
                        <div class="col-md-6 col-lg-6 mt-3">
                            ...
                            <div class="input-group mb-3">
                                <input class="form-control qf-shadow-input" name="tcs_rate" type="number" step="0.01" min="0" placeholder="Enter TCS Rate %" value="{{$data['tcs_rate']}}">
                        ...
                        <div class="col-md-6 col-lg-6 mt-3">
                            ...
                            <div class="input-group mb-3">
                                <input class="form-control qf-shadow-input" type="number" name="exempt" min="0" placeholder="Enter Exempt" value="{{$data['exempt']}}">
