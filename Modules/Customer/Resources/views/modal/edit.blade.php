    ...
    <div class="modal-dialog  modal-lg modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{url('admin-login/customer/update')}}/{{$data['id']}}" method="post" class="form form-vertical save-form" id="save-customer-form">
                    <div class="row">

                        <div class="col-md-12 col-lg-12  mt-3">
                            <label class="d-none">Customer Name*</label>
                            <div class="input-group mb-3">
                                <input class="form-control  qf-shadow-input" type="text" name="name" value="{{$data['name']}}" placeholder="Enter Customer/Agent Name">
                        ...
                        <div class="col-md-12 col-lg-12  mt-3">
                            ...
                            <div class="input-group mb-3">
                                <input class="form-control qf-shadow-input" type="text" oninput="this.value=this.value.replace(/[^0-9]/g,'');" maxlength="16" name="mobile" value="{{$data['mobile']}}" placeholder="Enter Mobile Number">
